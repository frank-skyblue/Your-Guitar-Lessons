          ...
          <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    pathname === item.href
                      ? "bg-mobile-nav-highlight"
                      : "hover:bg-mobile-nav-hover",
              ...
              {isAuthenticated ? (
                <Disclosure.Button
                  as="button"
                  className="w-full hover:bg-mobile-nav-hover block rounded-md px-3 py-2 text-sm text-left font-medium disabled:opacity-50"
                  onClick={handleLogout}
                  disabled={isLoading}
                >
                  {isLoading ? "Logging out..." : "Logout"}
